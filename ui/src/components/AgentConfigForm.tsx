...
const ENABLED_ADAPTER_TYPES = new Set(["claude_local", "claude_api", "codex_local", "gemini_local", "opencode_local", "pi_local", "cursor", "hermes_local", "openrouter", "openai_compatible", "process", "http"]);
