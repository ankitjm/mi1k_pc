...
export function MetricCard({ icon: Icon, value, label, description, to, onClick }: MetricCardProps) {
  ...
  const inner = (
    <div className={`h-full px-4 py-4 sm:px-5 sm:py-5 rounded-xl border border-border/50 bg-card/50 transition-colors${isClickable ? " hover:bg-accent/10 cursor-pointer" : ""}`}>
